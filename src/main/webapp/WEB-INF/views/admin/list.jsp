        ...
        <table class="table table-hover text-center">
            ...
            <volist name="list" id="vo">
                <tr>
                    ...
                    <td width="10%"><img src="/img/admin/11.jpg" alt="" width="70" height="50" /></td>
                ...
                <tr>
                    ...
                    <td>产品分类</td>
                    <td>2016-07-01</td>
                    <td><div class="button-group"> <a class="button border-main" href="/admin/add.html"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="javascript:void(0)" onclick="return del(1,1,1)"><span class="icon-trash-o"></span> 删除</a> </div></td>
                </tr>
                <tr>
                    <td style="text-align:left; padding-left:20px;"><input type="checkbox" name="id[]" value="" />
                        1</td>
